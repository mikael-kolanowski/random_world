...
class Tree(pygame.sprite.Sprite):
    def __init__(self,g, pos, *groups):
        ...
        self.image = pygame.image.load("img/tree.jpeg")
...
class Axe(pygame.sprite.Sprite):
    def __init__(self,g, pos, *groups):
        ...
        self.image = pygame.image.load("img/axe.png")
...
class Revolver(pygame.sprite.Sprite):
    def __init__(self, g, pos, *groups):
        ...
        self.image = pygame.image.load("img/gun1.jpg")
        self.rect = self.image.get_rect()
        self.rect.x, self.rect.y = pos[0], pos[1]
...
class DreadMonster(pygame.sprite.Sprite):
    def __init__(self, g, *groups):
        ...
        self.image = pygame.image.load("img/dread_monster.jpg")
        self.rect = self.image.get_rect()
        self.rect.x = 1000
        self.rect.y = 5
...
class DreadBullet(pygame.sprite.Sprite):
    def __init__(self,g ,pos, *groups):
        #self.image = pygame.image.load("img/shampoo_projectile.jpg")
...
class Player(pygame.sprite.Sprite):
    def __init__(self, g, pos, *groups):
        ...
        self.image = pygame.image.load("img/Adolf_Hitler_portrait.jpg")
        self.rect = self.image.get_rect()
        self.rect.x, self.rect.y = pos[0], pos[1]
